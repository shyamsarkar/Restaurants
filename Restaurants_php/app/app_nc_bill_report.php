...
$pagename = "app_nc_bill_report.php";
$search_sql = "";
  ...
  <div class="container" style="width:100%;"><br>
         ...
         <form class="col m6 offset-m3 s12">
            <div class="row">
               <div class="input-field col s4">
                  ...
                  <label class="active">Table No. </label>
               </div>
               <div class="input-field col s4">
      ...
      <div class="row">
         <div class="col m6 offset-m3 s12">
            <blockquote>
               <h6>Not Chargeable Bill Report List</h6>
            </blockquote>
            ...
            <footer class="page-footer">
               <div class="footer-copyright">
                  <table>
                     <tr>
                        <th>Total NC Amount</th><th class="right-align"><?php echo number_format($subtotal,2); ?></th>
                     </tr>
