   ...
   <div class="container" style="width:100%;"><br>
         ...
         <form class="col m6 offset-m3 s12">
            <div class="row">
               <div class="input-field col s12">
                  ...
                  <label class="active">Supplier <span class="red-text">*</span></label>
                  <script>
               ...
               <div class="input-field col s6">
                  <button class="btn waves-effect waves-light" type="submit" name="search" onClick="return checkinputmaster('supplier_id,from_date,to_date'); " value="Search" style="width: 100%;">Search<i class="material-icons right">search</i>
                  </button>
               </div>
               <div class="input-field col s6">
                  <a class="waves-effect waves-light red btn" href="../admin/pdf_sale_bill_report.php?supplier_id=<?php echo $dsupplier_id; ?>&product_name=<?php echo $product_name; ?>&from_date=<?php echo $from_date; ?>&to_date=<?php echo $to_date; ?>" style="width: 100%;" target="_blank"><i class="material-icons right">print</i>print</a>
      ...
      <div class="row">
         <div class="col m6 offset-m3 s12">
            <blockquote>
               <h6>Supplier Wise Report List</h6>
            </blockquote>
                  ...
                  <div class="card-content">
                     <table class="striped">
                        <tbody>
                           ...
                           <tr>
                              <td>Customer</td>
                              <td class="right-align"><?php echo $customername; ?></td>
                           </tr>
                           <tr>
                              <td>Goods Name</td>
                           ...
                           <tr>
                              <td>BillAmt</td>
                              <td class="right-align"><?php echo $net_amount; ?></td>
                           </tr>
