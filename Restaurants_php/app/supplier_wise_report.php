...
$pagename = "supplier_wise_report.php";
...
if (isset($_GET['supplier_id'])) {
   ...
   $supplier_name = $obj->getvalfield("master_supplier", "supplier_name", "supplier_id='$dsupplier_id'");
}
         ...
         <form class="col m6 offset-m3 s12">
            <div class="row">
               <div class="input-field col s12">
                  ...
                  <select name="supplier_id" id="supplier_id" class="js-example-basic-single browser-default">
                  ...
                  <script>
                     document.getElementById('supplier_id').value = '<?php echo $dsupplier_id; ?>';
                  </script>
               ...
               <div class="input-field col s6">
                  <button class="btn waves-effect waves-light right" style="width: 80%;" type="submit" name="search" onClick="return checkinputmaster('supplier_id,from_date,to_date'); "><i class="material-icons right">search</i>Search
                  </button>
               </div>
               <div class="input-field col s6">
                  <a class="waves-effect waves-light red btn left" style="width:80%;" href="../admin/pdf_supplier_bill_report.php?supplier_id=<?php echo $dsupplier_id; ?>&product_name=<?php echo $product_name; ?>&from_date=<?php echo $from_date; ?>&to_date=<?php echo $to_date; ?>" target="_blank"><i class="material-icons right">print</i>print</a>
               </div>
            </div>
         </form>
      </div>
                        ...
                        <tbody>
                           ...
                           <?php if ($sale_payamt > 0) { ?>
                              <tr>
                                 ...
                                 <td>Rec Date</td>
                                 <td><?php echo $obj->dateformatindia($pay_date); ?></td>
                              </tr>
                              <tr>
                           ...
                           <tr>
                              ...
                              <td><?php echo round($disc_amt, 2); ?></td>
                           </tr>
                           <tr>
                              <td>Payable</td>
                              <td><?php echo round($payable_amt, 2); ?></td>
                           </tr>
                           <tr>
                              <td>Recieved Amount</td>
                              <td><?php echo round($sale_payamt, 2); ?></td>
                           </tr>
                           <tr class="red lighten-5">
                              <td><strong>Net Amount</strong></td>
                              <td><strong>&#x20B9; <?php echo round($netamt, 2); ?></strong></td>
                           </tr>
