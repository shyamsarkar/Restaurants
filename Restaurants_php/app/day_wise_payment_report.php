...
$pagename = "day_wise_payment_report.php";
  ...
  <div class="container" style="width:100%;"><br>
      ...
      <div class="row">
         <div class="col m6 offset-m3 s12">
            <blockquote>
               <h6>Day Wise Payment Report List</h6>
            </blockquote>
             ...
             <?php
              $slno=1;
                        ...
                        $net_bill_amt = $obj->getvalfield("bills","sum(net_bill_amt)","checked_nc=0");
               ...
               <div class="card-content">
                  <table class="striped">
                     <tbody>
                        ...
                        <tr>
                           <td>Total Sale</td>
                           <td class="right-align"><?php echo number_format($net_bill_amt,2); ?></td>
                        </tr>

                         <tr>
                           <td>Cash</td>
                           <td class="right-align"><?php echo number_format($cash_amt,2); ?></td>
                        </tr>
                        <tr>
                           <td>Online</td>
                           <td class="right-align"><?php echo number_format($online_pay,2); ?></td>
                        </tr>
                        <tr>
                           <td>Settlement</td>
                           <td class="right-align"><?php echo number_format($settlement_amt,2); ?></td>
                        </tr>
                        <tr>
                           <td>Credit</td>
                           <td class="right-align"><?php echo number_format($credit_amt,2); ?></td>
                        </tr>
                        <tr>
                           <td>Expense</td>
                           <td class="right-align"><?php echo number_format($expense,2); ?></td>
                        </tr>
           ...
           <!--  <footer class="page-footer">
               <div class="footer-copyright">
                  <div class="container">
                  <strong>Total</strong>
                  <strong class="right">&#x20B9; <?php echo number_format(round($tot_total_sale),2);  ?></strong>
             ...
             <footer class="page-footer">
               <div class="footer-copyright">
                  <table>
                     <tr>
                        <th>Total Sale Amount</th><th class="right-align"><?php echo number_format($tot_total_sale,2); ?></th>
                     </tr>
                     <tr>
                        <th>Total Cash</th><th class="right-align"><?php echo number_format($tot_cash_amt,2); ?></th>
                     </tr>
                     <tr>
                        <th>Total Online</th><th class="right-align"><?php echo number_format($tot_online_pay,2); ?></th>
                     </tr>
                     <tr>
                     ...
                     <tr>
                        <th>Total Expence</th><th class="right-align"><?php echo number_format($tot_expense,2); ?></th>
                     </tr>
                  </table>
               </div>
            </footer>
