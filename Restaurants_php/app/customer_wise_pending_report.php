...
$pagename = "customer_wise_pending_report.php";
      ...
      <div class="row">
         <form class="col m6 offset-m3 s12">
            <div class="row">
               ...
               <div class="input-field col s6">
                  <a class="waves-effect waves-light red btn" href="../admin/pdf_customer_bill_pending_report.php?customer_id=<?php echo $dcustomer_id; ?>&product_name=<?php echo $product_name; ?>&from_date=<?php echo $from_date; ?>&to_date=<?php echo $to_date; ?>" style="width: 100%;" target="_blank"><i class="material-icons right">print</i>print</a>
