...
$pagename = "report_demand_entry.php";
$module = "Report Demand Entry";
$submodule = "Demand Entry Report";
$btn_name = "Save";
$keyvalue =0 ;
...
if(isset($_GET['supplier_id']))
{
  ...
  if(!empty($supplier_id))
  	$crit .= " and demand_entry.supplier_id = '$supplier_id'";
}
            ...
            <div>
            	...
            	<table class="table table-bordered" id="dyntable">
                  ...
                  $totalamt=0;
	                ...
	                $sql = "select * from demand_entry left join demand_detail on demand_entry.demand_id = demand_detail.demand_id $crit";
	                $res = $obj->executequery($sql);
	                foreach($res as $row_get)
				    {
					///$total=0;
					$demand_id = $row_get['demand_id'];

					$supplier_id = $row_get['supplier_id'];

					$demand_order_no = $row_get['demand_order_no'];
					$qty = $row_get['qty'];
					...
					$demand_date =$obj->dateformatindia($row_get['demand_date']);
					...
					<td><?php echo $demand_order_no; ?></td>
					<td><?php echo $demand_date; ?></td>
					<td><?php echo $qty; ?></td>
				
					<td><center><a class="btn btn-danger" href="pdf_demand_invoice.php?demand_id=<?php echo $row_get['demand_id']; ?>" target="_blank">InvoiceA5</a></center></td>
