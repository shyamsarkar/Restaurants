...
$pdf->Cell(42,5,'Particular',0,0,'L',0);

//$pdf->Cell(11,5,'Unit',0,0,'C',0);

$pdf->Cell(10,5,'Qty',0,1,'R',0);

$pdf->SetWidths(array(42,10));
...
$slno=1;
    ...
    $pdf->Row(array($prodname,$qty),1,1,'L',0); 
...
$pdf->Ln(10);*/
$pdf->Image("images/mohandhaba_logo.png", 6, $pdf->Ln(10),55,30);
...
$pdf->Ln(-13);
     ...
     //   $pdf->MultiCell(65,5,$address1." GST ".$gstc." FSSAI No.".$fssai_no." ".$title4,0,'L');

       
        $pdf->SetFont('courier','b',7.5);
        $pdf->Cell(20,0,'ABHANPUR ROAD CHHATTISGARH',0,0,'L');
        $pdf->Ln(3);
        $pdf->SetX(2);
        $pdf->SetFont('courier','b',7.9);
        $pdf->Cell(20,0,'GST NO.    : '.$gstc,0,0,'L');

        $pdf->Ln(3);
        $pdf->SetX(2);
        $pdf->SetFont('courier','b',7.9);
        $pdf->Cell(20,0,'FSSAI NO.  : '.$fssai_no,0,0,'L');

        $pdf->Ln(3);
        $pdf->SetX(2);
        $pdf->SetFont('courier','b',7.9);
        $pdf->Cell(20,0,'Mobile No1.: 6232072450',0,0,'L');
        $pdf->Ln(3);
        $pdf->SetX(2);
        $pdf->SetFont('courier','b',7.9);
        $pdf->Cell(20,0,'Mobile No2.: 9425205375',0,0,'L');
...
$pdf->Cell(20,6,"Order Id    : ",'0',0,'L',0);
...
$pdf->Cell(20,6,"OTP Code : ",'0',0,'L',0);
$pdf->SetX(26);
$pdf->SetFont('Arial','b',11);
$pdf->Cell(30,6,$order_otp,'0',0,'L',0); 
