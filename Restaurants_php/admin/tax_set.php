                    ...
                    <form class="stdform stdform2" method="post" action="">
                        <div class="row-fluid">
                          <table class="table table-condensed table-bordered">
                            <tr>
                                <tr>
                                  <th>For Food Tax Setting :</th>
                                  <th>For Bevrages Tax Setting :</th>
                                </tr>
                              <tr>
                                <td>
                                  <table class="table table-condensed table-bordered">
                                    ...
                                    <tr>
                                       ...
                                       <td><label><input type="checkbox" name="is_applicable" value="1"<?php if($is_applicable_food == "1") echo 'checked';?> > yes</label></td>
                                    </tr>

                                    <tr>
                                       <td></td>
                                       <td> <button  type="submit" name="save_food" class="btn btn-primary" onClick="return checkinputmaster(''); ">
                            ...
                            <td>
                                <table class="table table-condensed table-bordered">
                                   ...
                                   <tr>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td><button  type="submit" name="save_bevrages" class="btn btn-primary" onClick="return checkinputmaster(''); ">
                                        <?php echo $btn_name; ?></button>
                                        <a href="tax_setting.php"  name="reset" id="reset" class="btn btn-success">Reset</a>
                                        <input type="hidden" name="<?php echo $tblpkey; ?>" id="<?php echo $tblpkey; ?>" value="<?php echo $keyvalue; ?>">
