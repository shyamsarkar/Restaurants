...
$pdf->Cell(190,6,'Floor Name.',1,1,'L',0);
...
$slno=1;
        ...
        $sql1 = $obj->executequery("select * from m_floor order by floor_id desc");
       foreach ($sql1 as $sql) {
        //print_r($sql);
    ...
    $pdf->Row(array($slno++,$sql['floor_name']));
}
