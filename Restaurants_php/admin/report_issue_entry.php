...
$pagename = "report_issue_entry.php";
$module = "Report Issue Entry";
$submodule = "Issue Entry Report";
$btn_name = "Save";
$keyvalue =0 ;
$tblname = "issue_entry";
$tblpkey = "issueid";
            ...
            <div>
            	...
            	<table class="table table-bordered" id="dyntable">
                  ...
                  $totalamt=0;
					...
					<td><center><a class="btn btn-danger" href="pdf_issueentry.php?issueid=<?php echo $row_get['issueid']; ?>" target="_blank">InvoiceA5</a></center></td>
