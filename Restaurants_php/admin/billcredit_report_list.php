...
$pagename ="billcredit_report_list.php";   
$module = "Bill Wise Credit Sale Report";
$submodule = "Bill Wise Credit Sale Report List";
$btn_name = "Search";
$keyvalue =0 ;
$tblname = "bills";
$tblpkey = "billid";
        	...
        	<div class="contentinner">
              <?php include("../include/alerts.php"); ?>
                ...
                <div class="widgetcontent  shadowed nopadding">
                    ...
                    <td>&nbsp; <a href="billcredit_report_list.php"  name="reset" id="reset" class="btn btn-success">Reset</a></td>
                ...
                <!--widgetcontent-->
                  <?php $chkview = $obj->check_pageview("billcredit_report_list.php",$loginid);             
                    if($chkview == 1 || $_SESSION['usertype']=='admin'){  ?>
                     
                    <p align="right" style="margin-top:7px; margin-right:10px;"> <a href="pdf_billcredit_report.php?fromdate=<?php echo $fromdate;?>&todate=<?php echo $todate;?>" class="btn btn-info" target="_blank">
            	...
            	<table class="table table-bordered" id="dyntable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th  class="head0">Cancel Bill</th>
                             <?php  $chkdel = $obj->check_delBtn("billcredit_report_list.php",$loginid);             
                    ...
                    <tbody id="record">
                        ...
                        <td>
                          ...
                          <?php echo "Bill Time".$row_get['billtime']; ?>
                        </td>
                        ...
                        <td>
                          ...
                          <?php echo "G-Pay: ".number_format($row_get['google_pay'],2); ?>
                        </td>
                        <td>
                        ...
                        //$tot_rec_amt += $row_get['rec_amt'];
            						$tot_rec_amt += $row_get['cash_amt'] + $row_get['card_amt'] + $row_get['paytm_amt'] + $row_get['google_pay'];
                ...
                <table class="table tab-content" style="font-size:16px;" >
                    ...
                    <tr>
                     ...
                     <!-- <tr>
                        <td style="text-align:right;width:85%">Total Disc Amt :</td>
