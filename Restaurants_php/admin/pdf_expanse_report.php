...
$pdf->Cell(50,6,'Expense Date',1,0,'L',0);
$pdf->Cell(50,6,'Expense Amount',1,1,'R',0);
$pdf->SetX(5);
...
foreach($res as $row_get)
{
  ...
  $net_amount =$row_get['exp_amount'];
    ...
    $pdf->Row(array($slno++,strtoupper($group_name),strtoupper($row_get['exp_name']),$obj->dateformatindia($row_get['exp_date']), number_format($net_amount,2)));
    $totalamt+=$net_amount;
}
$pdf->SetX(5);
