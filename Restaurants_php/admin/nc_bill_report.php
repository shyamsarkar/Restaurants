...
$pagename ="nc_bill_report.php";   
$module = "Not Chargeable Bill Report";
$submodule = "Not Chargeable Bill Report List";
$btn_name = "Search";
$keyvalue =0 ;
$tblname = "bills";
$tblpkey = "billid";
        	...
        	<div class="contentinner">
              <?php include("../include/alerts.php"); ?>
                ...
                <?php $chkview = $obj->check_pageview("bill_report_list.php",$loginid);             
                    ...
                    <p align="right" style="margin-top:7px; margin-right:10px;"> <a href="pdf_ncbill_report.php?table_id=<?php echo $table_id; ?>&fromdate=<?php echo $fromdate;?>&todate=<?php echo $todate;?>" class="btn btn-info" target="_blank">
                ...
                <table class="table tab-content" style="font-size:16px;" >
                	<tr>
                        <td style="text-align:right;width:85%">Total NC Amount :</td>
