...
if (isset($_GET['table_id'])) {
    ...
    $billid  = (int)$obj->test($_GET['billid']);
    ...
    $qry = array('kotid' => (int)$lastkotid);
    $where = array('table_id' => $table_id, 'billid' => (int)$billid, 'kotid' => '0');
