...
$pagename = "kot_report.php";
$module = "KOT Report";
$submodule = "KOT Report";
$btn_name = "Save";
$keyvalue =0 ;
$tblname = "";
$tblpkey = "";
          ...
          <table class="table table-bordered table-condensed">
            ...
            <tr>
              ...
              <td><input type="text" name="to_date" id="to_date" class="input-medium"  placeholder='dd-mm-yyyy'
                 ...
                 <td>&nbsp; <a href="kot_report.php"  name="reset" id="reset" class="btn btn-success">Reset</a></td>
               </tr>
             </table>
            ...
            <div>
      <!-- for print pdf -->
      <?php $chkview = $obj->check_pageview("kot_report.php",$loginid);             
          if($chkview == 1 || $_SESSION['usertype']=='admin'){  ?>
         <p align="right" style="margin-top:7px; margin-right:10px;"> <a href="pdf_kot_report.php?from_date=<?php echo $from_date; ?>&to_date=<?php echo $to_date; ?>" class="btn btn-info" target="_blank">
          ...
          <table class="table table-bordered" id="dyntable">
            <thead>
              <tr>
                ...
                <th  class="head0">KOT No.</th>
                <th  class="head0">Bill No.</th>
                <th  class="head0">KOT Date</th>
                <th  class="head0">KOT Time</th>
                <th  class="head0">Total_Count_Product</th>
                <th  class="head0">Table No.</th>
                <th  class="head0">Floor No.</th>
            ...
            foreach($res as $row_get)
            {
              ...
              ?> <tr>
                <td><?php echo $slno++; ?></td>
                <td><a target="_blank" href="pdf_restaurant_kot_recipt_new.php?kotid=<?php echo $kotid; ?>">
                  <?php echo "KOT No: ".$row_get['kotid']; ?>
                </td>
                <td><a href="pdf_restaurant_recipt.php?billid=<?php echo $row_get['billid'] ?>" target="_blank"><?php echo $billnumber; ?></a></td>
                <td><?php echo $kotdate; ?></td>
                <td><?php echo $kottime; ?></td>
                <td><?php echo $count_product; ?></td>
                <td><?php echo $table_no; ?></td>
                <td><?php echo $floor_name; ?></td>
                
                <!-- <td style="text-align: right;"><?php //echo number_format(round($net_amount),2); ?></td> -->
              </tr>
              <?php
              $tot_kot_no = $slno - 1;
              }//looop close
          ...
          <div class="well well-sm text"><h3 class="text-info text-right">Total KOT No.: <?php echo $tot_kot_no; ?></h3></div>
        <?php } ?>
          </div> 
        </div><!--contentinner-->
      </div><!--maincontent-->
