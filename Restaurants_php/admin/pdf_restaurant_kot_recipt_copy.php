...
{	
	...
	//echo $kotid = $obj->getvalfield("kot_entry","kotid","table_id='$table_id' and billid=0 limit 0,1");die;
	// if($kotid!='')
	// {
	// 	$lastkotid = $kotid;
	// }
...
class PDF_AutoPrint extends PDF_JavaScript
{
  ...
  var $aligns;
	...
	function Header()
	{
		global $title1,$title2,$title3,$title4,$lastkotid;
		 // courier 25
...
//echo "select * from bill_details LEFT JOIN m_product ON bill_details.productid = m_product.productid where bill_details.kotid='$lastkotid' and m_product.foodtypeid='2'";die;
    $sql_get = $obj->executequery("select * from view_bill_details  where kotid='$lastkotid' and foodtypeid='2'");
