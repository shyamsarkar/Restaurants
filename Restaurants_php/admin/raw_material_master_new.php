            ...
            <form class="stdform stdform2" method="post" action="" enctype="multipart/form-data">
               ...
               <table class="table table-bordered"> 
                ...
                <tr>      
                  ...
                  <td>
                    ...
                    <select name="pcatid" id="pcatid"  class="chzn-select" style="width:283px;">
              ...
              <script>document.getElementById('pcatid').value = '<?php echo $pcatid; ?>';</script>
                  ...
                  <select name="product_type" id="product_type"  class="chzn-select" style="width:283px;" >
                    <option value="" >---Select---</option>
                    <option value="packed material">Packed Material</option>
                    <option value="menu material">Menu Material</option>
                        ...
                        <table class="table table-bordered" id="dyntable">
                          ...
                          <thead>
                            ...
                            foreach($res as $row_get)
                            {
                                ...
                                $zomato_rate = $row_get['zomato_rate'];
                              ...
                              <tr>
                                <td><?php echo $slno++; ?></td>
                                <td>
                                  <b>Product Name:</b>&nbsp;<?php echo $row_get['prodname']; ?><br>
                                  <b>Rate:</b>&nbsp;<?php echo $row_get['rate']; ?><br>
                                  <b>Product Category:</b>&nbsp;<?php echo $category_name; ?><br>
