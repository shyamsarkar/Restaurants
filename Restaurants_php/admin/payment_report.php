...
$pagename = "payment_report.php";
$module = "Report Payment Entry";
$submodule = "Payment Entry Report";
$btn_name = "Save";
$keyvalue =0 ;
            ...
            <div>
            	...
            	<table class="table table-bordered" id="dyntable">
                  ...
                  $totalamt=0;
                              ...
                              $sql = "select * from bills left join bill_details on bills.billid = bill_details.billid $crit";
                            ...
                            <td><?php echo $qty; ?></td>
                            <td><?php echo $rate; ?></td>
                            <td><?php echo $basic_bill_amt; ?></td>
                            <td><?php echo $net_bill_amt; ?></td>
