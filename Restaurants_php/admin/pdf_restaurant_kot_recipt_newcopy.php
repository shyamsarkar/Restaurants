...
class PDF_AutoPrint extends PDF_JavaScript
{
  ...
  var $aligns;
	...
	function Header()
	{
		global $title1,$title2,$title3,$title4,$lastkotid,$for_foods_check,$for_bev_check;
		 // courier 25
        if($for_foods_check > 0){
        ...
        //  $this->Ln(35);
        // $this->Line(3,62,60,62);

        // $this->SetDash(1,1); //5mm on, 5mm off
        // $this->Line(3,87,62,87);

        // $this->SetDash(1,1); //5mm on, 5mm off
        // $this->Line(3,94,62,94);

        // $this->SetDash(1,1); //5mm on, 5mm off
        // $this->Line(3,101,62,101);
