...
$pagename = "cancled_product_report.php";
$module = "Cancel Product Report";
$submodule = "Cancel Product Report";
$btn_name = "Save";
$keyvalue =0 ;
$tblname = "expanse";
$tblpkey = "expanse_id";
...
//   {
//     $from_date = $obj->dateformatusa($from_date);
//     $to_date = $obj->dateformatusa($to_date);
       ...
       <div class="contentinner content-dashboard">
        ...
        <form method="get" action="">
          <table class="table table-bordered table-condensed">
            ...
            <tr>
              ...
              <td><input type="text" name="from_date" id="from_date" class="input-medium"  placeholder='dd-mm-yyyy'
               ...
               <td><input type="text" name="to_date" id="to_date" class="input-medium"  placeholder='dd-mm-yyyy'
                 ...
                 <td>&nbsp; <a href="cancled_product_report.php"  name="reset" id="reset" class="btn btn-success">Reset</a></td>
               </tr>
             </table>
           ...
           <div>
      <!-- for print pdf -->
       <?php $chkview = $obj->check_pageview("cancled_product_report.php",$loginid);             
                    if($chkview == 1 || $_SESSION['usertype']=='admin'){  ?>
         <p align="right" style="margin-top:7px; margin-right:10px;"> <a href="pdf_calcel_product.php?from_date=<?php echo $from_date; ?>&to_date=<?php echo $to_date; ?>" class="btn btn-info" target="_blank">
