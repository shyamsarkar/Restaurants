...
$pdf->Cell(30, 5, number_format(round($subtotal), 2), 1, 1, 'R', 0);
...
$pdf->SetX(5);
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(170, 5, 'Cancelled Amount: ', 1, 0, 'R', 0);
$pdf->Cell(30, 5, number_format(round($total_cancelled_amt), 2), 1, 1, 'R', 0);

$pdf->SetX(5);
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(170, 5, 'Total Rec Amt: ', 1, 0, 'R', 0);
$pdf->Cell(30, 5, number_format(round($tot_rec_amt), 2), 1, 1, 'R', 0);

$pdf->SetX(5);
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(170, 5, 'Balance Amount: ', 1, 0, 'R', 0);
$pdf->Cell(30, 5, number_format(round($net_balance), 2), 1, 1, 'R', 0);
