...
foreach ($res as $rowget) {
    ...
    $ret_date = $obj->getvalfield("purchasentry_detail", "ret_date", "purchaseid='$purchaseid'");
...
class PDF_MC_Table extends FPDF
{
    ...
    function Header()
    {
        global $title1, $title2, $company_name, $address, $gsttinNno, $company_address, $comp_mobile, $address, $company_code, $company_state, $title3, $title4, $tinno, $address2, $comp_name, $mobile, $tinno, $billno, $issuedate, $customer_name, $remark, $ret_date;
        //courier 25
        ...
        $this->SetFont('courier', 'b', 11);
        $this->Cell(63);
        $this->Cell(10, 0, "Sale Return Invoice", 0, 1, 'C');
        // Move to the right
        $this->Cell(90);
        // Title
        ...
        $this->SetX(5);
        $this->SetFont('courier', 'b', 9);
        $this->Cell(10, 5, "Cust.Name", 0, 0, 'L');
