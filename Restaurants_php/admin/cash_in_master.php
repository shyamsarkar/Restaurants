...
$pagename = "cash_in_master.php";
$module = "Cash In Master";
$submodule = "Cash In";
$btn_name = "Save";
$keyvalue = 0 ;
$tblname = "cash_in_out";
...
{
  $voucher_no = $obj->getcode_inout($tblname,"voucher_no","1=1 and type='cash_in'");
      ...
      <?php include("inc/header.php"); ?>
        ...
        <div class="maincontent">
          <div class="contentinner">
            ...
            <!-- for print pdf -->
              <!-- <p align="right" style="margin-top:7px; margin-right:10px;"> <a href="pdf_expense_master.php" class="btn btn-info" target="_blank">
                    <span style="font-weight:bold;text-shadow: 2px 2px 2px #000; color:#FFF">Print PDF</span></a></p> -->
                      ...
                      <?php  $chkview = $obj->check_pageview("cash_in_master.php",$loginid);             
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="head0">Narration</th>
                             ...
                             <?php  $chkedit = $obj->check_editBtn("cash_in_master.php",$loginid);              
                            if($chkedit == 1 || $_SESSION['usertype']=='admin'){  ?>
                            <th class="head0" style="text-align: center;">Edit</th> <?php } ?>
                            <?php  $chkdel = $obj->check_delBtn("cash_in_master.php",$loginid);             
            ...
            $res = $obj->executequery("select * from cash_in_out where type='cash_in' order by cash_inout_id desc");
            foreach($res as $row_get)
                {
                ...
                ?>   
                   <tr>
                       ...
                       <td style="text-align: center;"><a class='icon-edit' title="Edit" href='cash_in_master.php?cash_inout_id=<?php echo $row_get['cash_inout_id'] ; ?>'></a></td><?php } ?>
