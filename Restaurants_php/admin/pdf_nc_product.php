...
$pdf->Cell(25,6,'Bill No.',1,0,'L',0);
$pdf->Cell(25,6,'Bill Date',1,0,'L',0);
$pdf->Cell(60,6,'Product Name.',1,0,'L',0);
$pdf->Cell(15,6,'Unit',1,0,'L',0);
$pdf->Cell(15,6,'Qty',1,0,'L',0);
$pdf->Cell(20,6,'Table',1,0,'L',0);
$pdf->Cell(30,6,'Amount',1,1,'R',0);
$pdf->SetX(5);
$pdf->SetWidths(array(10,25,25,60,15,15,20,30));
$pdf->SetAligns(array('L','L','L','L','L','L','L','R'));
$pdf->SetFont('Arial','',6);
 $totalamt = 0;                                           
$res = $obj->executequery("select bills.billdate,nc_amount, bill_details.* from bill_details left join bills on bills.billid = bill_details.billid $crit and bills.checked_nc='1'");
...
foreach($res as $row_get)
{
    ...
    $pdf->Row(array($slno++,$billnumber,$billdate,$prodname,$unit_name,$qty,$table_no,number_format($nc_amount,2)));
    $totalamt+=$nc_amount;
}
$pdf->SetX(5);
 $pdf->SetFont('Arial','B',8);
 $pdf->SetTextColor(0,0,0);
$pdf->Cell(200,7,' Total  :-',1,'L',1);  
$pdf->Cell(0,7,number_format(round($totalamt),2),0,'R',0);
$pdf->Output();
?> 
