...
include("../adminsession.php");
 ...
 $res = $obj->executequery("select * from purchasentry_detail where purchaseid='$purchaseid' and sale_pur_type = 'sale'");
 $sn=1;
 $amount=0;
?>
...
?>                                   
 ...
 <p align="center">                                   
       ...
       <input type="submit" name="save" id="save" class="btn btn-primary" value="save"  />
        <a href="sales_return.php" class="btn btn-danger">Reset</a>
      <input type="hidden" name="purchaseid" value="<?php echo $purchaseid; ?>"  />
