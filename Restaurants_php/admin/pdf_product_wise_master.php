...
$pdf->Cell(40,6,'Date',1,0,'L',0);
$pdf->Cell(40,6,'Total Qty',1,0,'L',0);
$pdf->Cell(50,6,'Total Amount',1,1,'R',0);
$pdf->SetX(5);
$pdf->SetWidths(array(20,50,40,40,50));
...
$pdf->Row(array($slno++,strtoupper($prodname),$obj->dateformatindia($row_get['billdate']),$totqty,number_format($totamt,2)));
}
...
$pdf->Cell(50,7,number_format(round($grand_tot),2),1,'R',0);
$pdf->Output();
?> 
