...
if (isset($_POST['submit'])) {
  ...
  if ($purchaseid == 0) {
    $form_data = array('type' => $type, 'net_amount' => $net_amount, 'billno' => $billno, 'supplier_id' => $supplier_id, 'bill_date' => $bill_date, 'packing_charge' => $packing_charge, 'purchase_type' => $purchase_type, 'bill_type' => $bill_type, 'remark' => $remark, 'ipaddress' => $ipaddress, 'sessionid' => $sessionid, 'createdate' => $createdate, 'createdby' => $loginid);
    ...
    $form_data = array('net_amount' => $net_amount, 'billno' => $billno, 'supplier_id' => $supplier_id, 'bill_date' => $bill_date, 'packing_charge' => $packing_charge, 'purchase_type' => $purchase_type, 'bill_type' => $bill_type, 'remark' => $remark, 'ipaddress' => $ipaddress, 'lastupdated' => $createdate, 'createdby' => $loginid);
    ...
    <div class="rightpanel">
      ...
      <div class="maincontent">
        <div class="contentinner">
                  ...
                  <table width="100%" class="table table-bordered table-condensed">
                    ...
                    <tr>
                      <td>
                        ...
                        <select name="raw_id" id="raw_id" class="chzn-select" style="width:243px;" onChange="getproductdetail();">
                          <option value="">---Select---</option>
                          <?php
                          $crow = $obj->executequery("select * from raw_material order by raw_name asc");
          ...
          <?php $chkview = $obj->check_pageview("purchaseentry.php", $loginid);
              ...
              <table class="table table-bordered" id="dyntable">
                ...
                <thead>
                  <tr>
                    ...
                    <?php $chkedit = $obj->check_editBtn("purchaseentry.php", $loginid);
                    if ($chkedit == 1 || $_SESSION['usertype'] == 'admin') {  ?>
                      <th class="head0">Edit</th> <?php } ?>
                    <?php $chkdel = $obj->check_delBtn("purchaseentry.php", $loginid);
                ...
                <tbody id="record">
                  ...
                  <?php
                  $slno = 1;
                  $res = $obj->executequery("select * from purchaseentry $crit and type = 'purchaseentry'");
                  foreach ($res as $row_get) {
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <center><a class="btn btn-danger" href="pdf_purches_invoice.php?purchaseid=<?php echo  $row_get['purchaseid']; ?>" target="_blank"> Invoice A4 </a></center>
                      </td>

                      <?php $chkedit = $obj->check_editBtn("purchaseentry.php", $loginid);
                      if ($chkedit == 1 || $_SESSION['usertype'] == 'admin') {  ?>
                        <td><a class='icon-edit' title="Edit" href='purchaseentry.php?purchaseid=<?php echo  $row_get['purchaseid']; ?>' style='cursor:pointer'></a></td><?php } ?>&nbsp;
                        <?php $chkdel = $obj->check_delBtn("purchaseentry.php", $loginid);
      ...
      <table class="table table-condensed table-bordered">
        ...
        <tr>
          <td> <select name="state_id" id="state_id" class="chzn-select" style="width:230px;">
            ...
            <script>
              document.getElementById('state_id').value = '<?php echo $state_id; ?>';
            </script>
          </td>
    ...
    function addlist() {
      ...
      if (qty == '') {
        ...
        jQuery.ajax({
          ...
          data: 'raw_id=' + raw_id + '&unit_name=' + unit_name + '&qty=' + qty + '&rate_amt=' + rate_amt + '&cgst=' + cgst + '&sgst=' + sgst + '&igst=' + igst + '&purchaseid=' + purchaseid + '&purdetail_id=' + purdetail_id + '&inc_or_exc=' + inc_or_exc + '&disc=' + disc + '&taxable=' + taxable + '&cgst=' + cgst + '&sgst=' + sgst + '&igst=' + igst,
          dataType: 'html',
          success: function(data) {
            //alert(data);		
