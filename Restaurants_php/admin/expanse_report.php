...
$module = "Expanse Report Entry";
$submodule = "Expanse Report Master";
$btn_name = "Save";
$keyvalue =0 ;
$tblname = "expanse";
$tblpkey = "expanse_id";
...
<body onLoad="getrecord('<?php echo $keyvalue; ?>');">
  ...
  <div class="mainwrapper">
    ...
    <div class="rightpanel">
        ...
        <form method="get" action="">
          <table class="table table-bordered table-condensed">
            ...
            <tr>
              ...
              <td>
                <select name="ex_group_id" id="ex_group_id" class="chzn-select">
      ...
      <?php $chkview = $obj->check_pageview("expanse_report.php",$loginid);             
          ...
          <table class="table table-bordered" id="dyntable">
            <thead>
              <tr>
                ...
                <th  class="head0" style="text-align: right;">Expanse Amount</th>
              </tr>
            </thead>
            <tbody id="record">
            ...
            foreach($res as $row_get)
            {
              ...
              ?> <tr>
                <td><?php echo $slno++; ?></td>
                <td><?php echo $expanse_grp; ?></td>
                <td><?php echo $row_get['exp_name']; ?></td>
                <td><?php echo $row_get['exp_date']; ?></td>
