...
$pagename = "report_purchaseentry.php";
$module = "Report Purchase Entry";
$submodule = "Purchase Entry Report";
$btn_name = "Save";
$keyvalue =0 ;
            	...
            	<table class="table table-bordered" id="dyntable">
                    <thead>
                        <tr>
                            ...
                            <th  class="head0">Purchase Type</th>
                            <th  class="head0">Purchase Date</th>
                            <th  class="head0">Total</th>
                           <!--  <th width="26%" class="head0" style="text-align:center;">VoucherEntry</th>
                            <th width="26%" class="head0" style="text-align:center;">Print A5</th> -->
                  ...
                  $totalamt=0;
										...
										//$transport_charge =$row_get['transport_charge'];
										// $qty = $obj->getvalfield("saleentry_details","qty","saleid='$saleid'");
										// $rate_amt = $obj->getvalfield("saleentry_details","rate_amt","saleid='$saleid'");
										// $rate_amt = $obj->getvalfield("saleentry_details","igst","saleid='$saleid'");
										// $rate_amt = $obj->getvalfield("saleentry_details","sgst","saleid='$saleid'");
										// $rate_amt = $obj->getvalfield("saleentry_details","cgst","saleid='$saleid'");
                   // $total = $obj->getTotalSaleentryBillAmt($row_get['saleid']);	
                            ...
                            <td><?php echo number_format(round($net_amount),2); ?></td>
                           <!--  <td><a class="btn btn-success" onClick="getvoucher('<?php echo $row_get['saleid']; ?>','<?php echo $customer_name; ?>','<?php echo $customer_id; ?>','<?php echo $voucherno; ?>');" >VoucherEntry</a></td> -->
                       ...
                       <?php }else{ ?>
                       	 <td><center><a class="btn btn-danger" href="pdf_challan_invoice_purchase.php?purchaseid=<?php echo  $row_get['purchaseid']; ?>" target="_blank" > Invoice A4 </a></center></td>
                     <?php   } ?>
