...
$pagename = "report_stock.php";
$module = "Stock Report";
$submodule = "Stock Report";
$btn_name = "Save";
$keyvalue =0 ;
...
$crit = " where 1 = 1 and bill_date between '$from_date'"; 
            	...
            	<table class="table table-bordered" id="dyntable">
                    <thead>
                        <tr>
							...
							<th  class="head0">OpeningBal</th>
                          	<th  class="head0" >Purchase</th>
                            <th  class="head0">PurchaseRet.</th>
                            <th  class="head0">Sale</th>
                            <th  class="head0">SaleRet.</th>
                            <th  class="head0">Issue.</th>
                            <th  class="head0">IssueRet.</th>
                            <th  class="head0">StockInHand</th>
                    ...
                    <tbody id="record">
						    ...
						    $sql = "select * from purchaseentry left join purchasentry_detail on purchaseentry.purchaseid = purchasentry_detail.purchaseid and type='purchaseentry'";
							...
							$openingstock = $obj->getvalfield("m_product","opening_stock","product_id='$product_id'");
							$qty = $row_get['qty'];
