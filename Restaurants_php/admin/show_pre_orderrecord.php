...
$sn=1;
$where = array("pre_orderid"=>$pre_orderid);
$res = $obj->select_data("preentry_detail",$where);
$sn=1;
...
<table width="100%" class="table table-bordered table-condensed">
        ...
        <tr>
          ...
          <td class="center"><a class="btn btn-danger btn-small" onClick="deleterecord('<?php echo $pre_detail_id; ?>');"> X </a></td>
...
?>    
           ...
           <tr>
               ...
               <input type="text" value="<?php echo round($total_final_price); ?>" name="net_amount" style= "width:70px; border:none; font-weight:bold;text-align:right;" readonly="readonly"  />
               <?php
               }//if close
             else
             { 
 ...
 -->
      ...
      <input type="hidden" name="pre_orderid" value="<?php echo $pre_orderid; ?>"  />
      <a href="pre_order_entry.php" class="btn btn-primary" >Reset </a>
