...
$pdf->Cell(70,6,'Product.',1,0,'L',0);
$pdf->Cell(30,6,'OpeningStock(+).',1,0,'L',0);
$pdf->Cell(20,6,'Purchase(+)',1,0,'L',0);
$pdf->Cell(20,6,'Issue(+)',1,0,'L',0);
$pdf->Cell(20,6,'IssueRet(-)',1,0,'L',0);
$pdf->Cell(30,6,'Stock',1,1,'R',0);
$pdf->SetX(5);
$pdf->SetAligns(array('L','L','R','R','R','R','R','R'));
$pdf->SetWidths(array(10,70,30,20,20,20,30));
$pdf->SetFont('Arial','',6);
    ...
    $pdf->Row(array($slno++,strtoupper($raw_name),$Opening_stock,$purchase,$issue,$issue_ret,$stock_in_hand));
    }
