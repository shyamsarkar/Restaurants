...
function getrecord(purchaseid){
   // var emp_id=jQuery("#emp_id").val();
        ...
        jQuery.ajax({
        type: 'POST',
        url: 'show_sale_return_record.php',
   ...
   <div class="rightpanel">
      ...
      <div style="float:right;">
        ...
        <div class="maincontent">
            ...
            <?php   $chkview = $obj->check_pageview("sale_return.php",$loginid);              
            	...
            	<table class="table table-bordered" id="dyntable">
                    ...
                    <tbody id="record">
                                ...
                                <?php
									...
									$sql_get = $obj->executequery("Select * from purchaseentry $crit and type = 'saleentry' order by purchaseid desc");
                  foreach ($sql_get as $row_get) {
                            ...
                            <td>												
                            <a class="btn btn-danger" href="pdf_sale_return.php?purchaseid=<?php echo  $row_get['purchaseid']; ?>" target="_blank" > Print A5 </a></td>
                            <!-- <td>                                                  
